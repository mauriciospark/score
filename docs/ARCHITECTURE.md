...
### Escolha de Sistema de Pontos Ponderados

**Sistema de Pontos por Tipo de Contribuição**

- Commits: 1 ponto (contribuição básica)
- ContributedToNotOwnerRepositories: 10 pontos (contribuição em projetos externos)
- ContributedToOwnRepositories: 1 ponto (contribuição em projetos próprios)
- CreatedRepositories: 1 ponto (criação de projetos)
- DirectStars: 3.5 pontos (estrelas diretas em projetos)
- Followers: 1 ponto (seguidores)
- IndirectStars: 1 ponto (estrelas indiretas)
- Issues: 1 ponto (abertura de issues)
- PullRequests: 1 ponto (criação de PRs)
- PullRequestsToAnotherRepositories: 5 pontos (PRs em projetos externos)
- CommitsToMyRepositories: 1 ponto (commits em projetos próprios)
- CommitsToAnotherRepositories: 10 pontos (commits em projetos externos)
- ContributedTo: 1 ponto (contribuições gerais)

**Hierarquia de Ranks**

- S++: Elite Máxima (300.000+ pontos) - Performance Excepcional
- S+: Elite Superior (150.000+ pontos) - Performance de Alta Escala
- S: Elite (100.000+ pontos) - Performance Superior
- A+: Avançado (50.000+ pontos) - Alta Performance
- A: Avançado (20.000+ pontos) - Performance Consistente
- A-: Avançado (10.000+ pontos) - Performance Sólida
- B+: Intermediário (5.000+ pontos) - Acima da Média
- B: Intermediário (2.000+ pontos) - Média do Desenvolvedor
- B-: Intermediário (1.000+ pontos) - Abaixo da Média
- C+: Iniciante (500+ pontos) - Fase de Aprendizado
- C: Iniciante (0+ pontos) - Nível de Entrada
...
Aplicar margem de segurança (15%)
    ↓
Calcular pontos para cada tipo de contribuição
    ↓
Somar pontos totais
    ↓
Determinar Rank baseado em thresholds de pontos
```
...
- Sistema de pontos ponderados por tipo de contribuição
- Thresholds lineares para determinação de ranks
- Cálculo cumulativo de pontos totais
